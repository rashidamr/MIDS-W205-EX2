...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "zxpUlhx48jgVECNGLCi5OWAxL",
    "consumer_secret"     :  "zuOrPGfggluuXU55Dsn1wwZOYAP1zYmpioPbDBK2BOWfSkp4Br",
    "access_token"        :  "90927449-zqbTiMLxtorPzpT9rmWR9XopdjnAsUuoNwsMzh93Y",
    "access_token_secret" :  "DoGoXcnk0RS028lsF32KngYsFhe7EUX25etsQZD9dhOnR",
}
...
class Tweets(Spout):
    ...
    def next_tuple(self):
        try:
            tweet = self.queue().get(timeout = 0.02)
            if tweet:
